    ...
    <section className="py-32 px-6 bg-secondary text-secondary-foreground">
      <div className="max-w-[1600px] mx-auto">
        <div className="max-w-[800px]">
          <KineticReveal>
            <span className="text-[10px] font-mono uppercase tracking-[0.3em] text-foreground/50 mb-6 block">
              Get Involved
            </span>
          ...
          {intro && (
            <motion.p
              ...
              className="text-lg font-sans leading-relaxed text-foreground/70 mb-12 max-w-[560px]"
            >
              {intro}
            </motion.p>
          )}
