...
export default function Timeline() {
  ...
  return (
    <section className="py-24 lg:py-32 bg-platinum text-night-forest overflow-hidden border-t border-night-forest/10">
      <div className="max-w-[1600px] mx-auto px-6 w-full">
        <div className="max-w-2xl mb-16 lg:mb-24">
          <h3 className="font-mono text-[10px] tracking-[0.2em] uppercase mb-6 text-night-forest/50 flex items-center gap-4">
          ...
          <h2 className="text-4xl md:text-5xl lg:text-6xl font-serif font-light mb-6 tracking-tight leading-tight">
            Our journey of <span className="italic text-night-forest/60">impact</span>
          </h2>
          <p className="text-night-forest/70 leading-relaxed text-lg lg:text-xl font-sans">
      ...
      <div className="w-full px-6 lg:px-0 lg:pl-[max(1.5rem,calc((100vw-100rem)/2+1.5rem))]">
        <div className="relative w-full lg:-ml-12 lg:-mt-8 lg:pl-12 lg:pt-16 lg:overflow-x-auto lg:pb-24 lg:-mb-12 [scrollbar-width:none] [-ms-overflow-style:none] [&::-webkit-scrollbar]:hidden">
          <div className="flex flex-col lg:flex-row lg:gap-16 relative lg:min-w-max lg:pr-[360px]">
            ...
            <div className="absolute top-1/2 left-0 w-full h-[1px] bg-night-forest/20 -translate-y-1/2 z-0 hidden lg:block" />
            {/* Vertical line (mobile) */}
            <div className="absolute top-8 bottom-8 left-[17px] md:left-[21px] w-[1px] bg-night-forest/20 z-0 lg:hidden" />
              ...
              return (
                 <div key={idx} className="w-full lg:w-[360px] flex-shrink-0 flex flex-col lg:relative z-10 group relative pl-[48px] md:pl-[60px] lg:pl-0 mb-16 lg:mb-0">
                    ...
                    <div className="hidden lg:flex flex-1 min-h-[240px] flex-col justify-end pb-12 relative cursor-default">
                       {isEven ? (
                         <div className="w-full h-64 overflow-hidden relative border border-night-forest/10 transition-all duration-500 transform group-hover:-translate-y-3">
                         ...
                         <div className="bg-transparent p-0 transition-all duration-500 transform group-hover:-translate-y-2">
                            <span className="font-mono text-[10px] tracking-widest text-night-forest/50 uppercase mb-2 block border border-night-forest/10 w-fit px-2 py-1 bg-white">Year: {item.year}</span>
                            <h4 className="text-2xl font-serif font-light mb-4 leading-snug text-night-forest transition-colors">{item.title}</h4>
                            <p className="text-night-forest/70 text-sm leading-relaxed font-sans">{item.description}</p>
                         </div>
                       )}
                    </div>
                    ...
                    <div className="h-0 relative items-center justify-start hidden lg:flex z-10">
                       <div className="w-4 h-4 bg-platinum rounded-full border border-night-forest absolute left-[-8px] shrink-0 group-hover:scale-[1.5] group-hover:bg-neon-lime group-hover:border-night-forest transition-all duration-300" />
                    </div>
                    ...
                    <div className="lg:hidden flex flex-col relative w-full pt-2 cursor-default">
                       <div className="w-3 h-3 bg-platinum rounded-full border border-night-forest absolute left-[-35px] md:left-[-45px] top-[14px] shrink-0 z-10 transition-transform group-hover:scale-[1.5] group-hover:bg-neon-lime duration-300" />
                       <div className="bg-white p-6 border border-night-forest/10 transition-all duration-500 transform">
                         <span className="font-mono text-[10px] tracking-widest text-night-forest/50 uppercase mb-3 block border border-night-forest/10 w-fit px-2 py-1 bg-platinum">Year: {item.year}</span>
                         <h4 className="text-xl font-serif font-light mb-3 leading-snug text-night-forest">{item.title}</h4>
                         <p className="text-night-forest/70 text-[13px] font-sans leading-relaxed mb-6">{item.description}</p>
                         <div className="w-full h-48 md:h-64 overflow-hidden relative transition-all duration-300 border border-night-forest/10">
            ...
            <div className="w-full lg:w-[320px] flex-shrink-0 flex flex-col justify-center items-start lg:items-center pl-[48px] md:pl-[60px] lg:pl-0 relative z-10 group mt-4 lg:mt-0 lg:absolute lg:right-0 lg:top-1/2 lg:-translate-y-1/2">
                <div className="lg:hidden w-3 h-3 bg-night-forest rounded-full border border-night-forest absolute left-[9px] md:left-[13px] top-1/2 -translate-y-1/2 shrink-0 z-10 group-hover:scale-[1.5] transition-all duration-300 group-hover:bg-neon-lime" />
                <div className="w-full bg-night-forest p-8 md:p-10 text-center border border-night-forest/10 transition-all duration-500 flex flex-col items-center justify-center lg:h-[260px]">
                    <div className="w-12 h-12 bg-platinum rounded-full flex items-center justify-center mb-6 group-hover:scale-110 transition-transform duration-500">
                      <ChevronRight className="w-6 h-6 text-night-forest" />
                    </div>
                    <h4 className="font-serif font-light text-2xl mb-6 text-platinum">Ready to make an impact?</h4>
                    <Button asChild className="w-full bg-neon-lime text-night-forest hover:bg-neon-lime/90 px-6 h-12 text-[10px] font-mono tracking-widest uppercase transition-all font-bold active:scale-[0.98]">
