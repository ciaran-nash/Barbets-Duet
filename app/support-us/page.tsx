...
export default function SupportUsPage() {
  return (
    <main className="min-h-screen bg-night-forest text-platinum">
      {/* ── Hero / trust section ────────────────────────────────────────── */}
      <section className="relative pt-32 pb-16 px-6 border-b border-platinum/8 overflow-hidden">
        {/* Grid background */}
        ...
        <div className="relative max-w-3xl mx-auto text-center">
          <div className="font-mono text-[10px] tracking-[0.3em] uppercase text-platinum/35 mb-8 border border-platinum/10 px-5 py-2 rounded-full inline-block">
            [ Support our work ]
          </div>

          <h1 className="font-serif text-5xl md:text-7xl font-light leading-[0.9] tracking-tight mb-8">
            <span className="italic text-platinum/50">Fund the</span>
            <br />
            <span className="text-neon-lime">Restoration</span>
          </h1>

          <p className="font-sans text-base text-platinum/60 leading-relaxed max-w-xl mx-auto">
      ...
      <section className="max-w-6xl mx-auto px-6 py-20">
        <div className="grid grid-cols-1 lg:grid-cols-5 gap-16">
          ...
          <div className="lg:col-span-3">
            <div className="mb-8">
              <p className="font-mono text-[10px] tracking-[0.3em] uppercase text-platinum/35 mb-3">
                Make a donation
              </p>
          ...
          <div className="lg:col-span-2 space-y-8">
            <div>
              <p className="font-mono text-[10px] tracking-[0.3em] uppercase text-platinum/35 mb-6">
              ...
              <div className="space-y-5">
                {[
                  ...
                  <div key={amount} className="flex gap-4 items-start">
                    <span className="font-serif text-xl text-neon-lime shrink-0 w-14">{amount}</span>
                    <p className="font-sans text-sm text-platinum/60 leading-relaxed pt-1">{impact}</p>
                  </div>
                ))}
              </div>
            </div>

            <div className="border-t border-platinum/10 pt-8">
              <p className="font-mono text-[10px] tracking-[0.3em] uppercase text-platinum/35 mb-4">
                Our network
              </p>
              <div className="grid grid-cols-3 gap-4">
                {[
                  ...
                  <div key={label} className="text-center border border-platinum/10 py-4 px-2">
                    <p className="font-serif text-2xl text-neon-lime">{value}</p>
                    <p className="font-sans text-[10px] text-platinum/45 mt-1 leading-tight">{label}</p>
                  </div>
                ))}
              </div>
            </div>

            <div className="border border-platinum/10 px-6 py-6 bg-white/3">
              <p className="font-serif text-sm italic text-platinum/70 leading-relaxed mb-4">
                &ldquo;The donation helped us rebuild what was lost and plant what the land needs next.&rdquo;
              </p>
              <p className="font-mono text-[9px] tracking-[0.2em] uppercase text-platinum/35">
